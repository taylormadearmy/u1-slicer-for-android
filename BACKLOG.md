...
### B137: Negative/modifier volumes sliced as solid objects on large (>64MB main-model) compound 3MFs (GitHub issue: TBD) — FIXED on `fix/paint-preview-dots` 2026-06-04, pending release
...
### B138: ProfileEmbedder.convertToModelSettings drops per-volume subtype for PrusaSlicer (non-Bambu) modifier 3MFs (GitHub issue: TBD) — OPEN 2026-06-04
