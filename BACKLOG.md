...
- ~~**`bug3_translate_preserved_through_slice` rewrite**~~ — **DONE**: `SetModelInstancesOffsetTest.bug3_hangingFile_translatePreservedThroughSlice` loads the 19 MB / 1.5 M tri hanging file, translates via `setModelInstances`, slices, and asserts G-code minX/minY land within ±5 mm of the requested origin. Long-running.
