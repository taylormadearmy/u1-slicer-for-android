...
- **Verification**: JVM tests cover canonical identity (including duplicate source colours), stable/missing/invalid mix resolution, physical tool-space decision, split/extended paint-state re-encoding, component-metadata rewriting, ZIP preservation, and session JSON round-trip. Complete JVM suite passes.
