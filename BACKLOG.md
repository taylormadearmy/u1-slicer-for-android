...
### F96: OpenPrintTag filament library + RFID sync matching (GitHub #176) — IMPLEMENTED on `feature/filament-library` 2026-06-10 (pending sanity test — not merged/released)
