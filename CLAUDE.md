...
```bash
./gradlew testDebugUnitTest                        # 597 JVM unit tests
...
### Unit tests (`app/src/test/`) - 597 tests across 38 classes
...
### Instrumented tests (`app/src/androidTest/`) - 139 tests across 14 classes
