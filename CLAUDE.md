...
Current release: `v1.6.12` (`versionCode 257`)
...
./gradlew connectedDebugAndroidTest                # 199 instrumented tests + 1 @Ignore'd (B95) — uses Orchestrator
```
...
### Instrumented tests (`app/src/androidTest/`) - 192 tests across 18 classes
