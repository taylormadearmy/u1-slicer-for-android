...
Current release: `v1.6.11` (`versionCode 256`)
...
./gradlew connectedDebugAndroidTest                # 198 instrumented tests + 1 @Ignore'd (B95) — uses Orchestrator
```
...
### Instrumented tests (`app/src/androidTest/`) - 191 tests across 18 classes
