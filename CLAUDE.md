...
Current release: `v2.10.12` (`versionCode 322`)
...
./gradlew connectedDebugAndroidTest                # 388 instrumented tests — uses Orchestrator
```
...
### Unit tests (`app/src/test/`) - 1444 tests across 123 classes
...
### Instrumented tests (`app/src/androidTest/`) - 391 tests across 46 classes (+1 ignored)
