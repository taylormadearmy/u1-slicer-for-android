...
Current release: `v2.10.14` (`versionCode 324`)
...
./gradlew connectedDebugAndroidTest      # 402 instrumented tests (ARM64 device required)
```

**1855 total tests** covering G-code parsing/validation, feature-type tagging, 3MF sanitization, STL parsing, slicing integration, profile embedding, Room DAOs, placement layout, native paint-state decoding, multi-plate canonical filament list, and more.
