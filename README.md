...
./gradlew connectedDebugAndroidTest      # 110 instrumented tests (ARM64 device required)
```

**484 total tests** covering G-code parsing/validation, 3MF sanitization, STL parsing, slicing integration, profile embedding, Room DAOs, placement layout, and more.
