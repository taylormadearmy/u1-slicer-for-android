...
Current release: `v2.2.15` (`versionCode 288`)
...
./gradlew connectedDebugAndroidTest      # 317 instrumented tests (ARM64 device required)
```

**1573 total tests** covering G-code parsing/validation, feature-type tagging, 3MF sanitization, STL parsing, slicing integration, profile embedding, Room DAOs, placement layout, native paint-state decoding, multi-plate canonical filament list, and more.
