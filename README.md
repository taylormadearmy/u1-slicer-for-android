...
Current release: `v2.2.12` (`versionCode 285`)
...
./gradlew connectedDebugAndroidTest      # 314 instrumented tests (ARM64 device required)
```

**1554 total tests** covering G-code parsing/validation, feature-type tagging, 3MF sanitization, STL parsing, slicing integration, profile embedding, Room DAOs, placement layout, native paint-state decoding, multi-plate canonical filament list, and more.
