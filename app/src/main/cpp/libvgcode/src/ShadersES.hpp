...
"  float r = floor(color / 65536.0);\n"
"  float g = floor(mod(color, 65536.0) / 256.0);\n"
...
"  float raw_color = texelFetch(color_tex, tex_coord(color_tex, id), 0).r;\n"
"  vec3 color_base = decode_color(raw_color);\n"
