...
internal val BAMBU_MACHINE_PROFILES: Map<SlicerTarget, BambuMachineProfile> = mapOf(
    ...
    SlicerTarget.BambuP2S to BambuMachineProfile(
        bedSizeX = 256f,
        bedSizeY = 256f,
        maxPrintHeight = 256f,
        printerModel = "Bambu Lab P2S",
        printerModelId = "GM049",
        printerSettingsId = "Bambu Lab P2S 0.4 nozzle",
        nozzleTypes = List(3) { "hardened_steel" },
        nozzleVolumes = List(3) { 110 },
        printerExtruderIds = List(3) { 1 },
        printerExtruderVariants = listOf(
            "Direct Drive Standard",
            "Direct Drive High Flow",
            "Direct Drive E3D High Flow",
        ),
        extruderVariantList = listOf("Direct Drive Standard,Direct Drive High Flow,Direct Drive E3D High Flow"),
        defaultPlaFilamentSettingsId = "Bambu PLA Basic @BBL P2S",
    ),
